...
# Byte-identical (schema-wise) to specs/phases/01-mock-app-db/apartment_market_segments.sql
# — kept as a Python string rather than read from that file at runtime so this
